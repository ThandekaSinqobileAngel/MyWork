...
class Shoe:
    ...
    def read_data(self):
        """Reads data from text file and creates Shoe() objects with
        data.
...
def lowest_quantity(shoes):
    ...
    Args:
        shoes (list): List of Shoe() objects to determine the lowest
        stock count of.
    """
...
def highest_quantity(shoes):
    ...
    Args:
        shoes (list): List of Shoe() objects to determine the highest
        stock count of.
    """
...
def locate_item(shoes):
    """Locates shoe in list with corresponding code and returns the
    shoe
    """
